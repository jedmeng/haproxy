...
class AliDevice {
  ...
  static isSupport(device) {
    return TypeMap[device.domain];
  }
  ...
  async initProperties() {
    ...
    if (this.device.isSupport(DeviceConst.FEATURE_TEMPERATURE)) {
      ...
      try {
        ...
        temperature = this.app.helper.conventTempUnit(temperature, unit, DeviceConst.UNIT_TEMP_CELSIUS);
      } catch (e) {}
  ...
  async setTemperature(value) {
    ...
    value = this.app.helper.formatNumber(value, 0, min, max);
