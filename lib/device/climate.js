...
const {
  ATTR_MAX_TEMPERATURE, ATTR_MIN_TEMPERATURE, ATTR_CURRENT_TEMPERATURE,
  ATTR_TEMPERATURE, ATTR_TEMPERATURE_HIGH, ATTR_TEMPERATURE_LOW,
...
class Climate extends ControllableDevice {
  ...
  isSupport(feature) {
    if ([FEATURE_ON_OFF, FEATURE_TOGGLE].includes(feature)) {
      return !!(this.featureMasks[SUPPORT_ON_OFF] & this.supportedFeatures);
